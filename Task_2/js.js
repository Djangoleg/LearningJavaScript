...
const map = {
    ...
    render(snakePointsArray, foodPoint, barrierPoint) {
        ...
        const barrierCellKey = `x${barrierPoint.x}_y${barrierPoint.y}`;
        const barrierCell = this.cells[barrierCellKey];
...
let barrier = Object.assign({}, food);
...
const gameScore = {
    ...
    render() {
        ...
        gameScore.textContent = this.header + this.score;
    },
    increment() {
        this.score += 1;
        this.render();
...
const game = {
    ...
    render() {
        ...
        this.map.render(this.snake.body, this.food.getCoordinates(), this.barrier.getCoordinates());
    },
    ...
    canMakeStep() {
        ...
        const barrierCoordinates = this.barrier.getCoordinates();

        return !this.snake.isOnPoint(nextHeadPoint) &&
            nextHeadPoint.x < this.config.getColsCount() &&
            nextHeadPoint.y < this.config.getRowsCount() &&
            !(nextHeadPoint.x == barrierCoordinates.x && 
                nextHeadPoint.y == barrierCoordinates.y) &&
            nextHeadPoint.x >= 0 &&
            nextHeadPoint.y >= 0;
    }
};
